...
class WeatherService {
  ...
  //   }
  // }
  Future<APIResponse> getWeather({String? lat, String? long}) async {
    try {
      var response = await http.get(Uri.parse(
          'https://api.openweathermap.org/data/2.5/weather?lat=$lat&lon=$long&appid=db56a9ab41e8ab1ab95dcffa4f67f119'));
      ...
      //   // weatherState.setWeatherData(data as Map<String, dynamic>);
      // }
       return APIResponse.fromJson({"message": "success", "data": data});
      // else {
      //   weatherState.error = 'Failed to load weather data: ${response.reasonPhrase}';
      //   print(weatherState.error);
      // }
